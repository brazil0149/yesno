...
export class MappingsService {
    ...
    getThreads(snapshot: any): Array<IThread> {
        ...
        Object.keys(snapshot.val()).map((key: any) => {
            ...
            threads.push({
                ...
                votesUp: this.itemsService.groupByBoolean(thread.votes, true),
                votesDown: this.itemsService.groupByBoolean(thread.votes, false)
            });
        });
    ...
    getThread(snapshot: any, key: string): IThread {
        let thread: IThread = {
            ...
            votesUp: this.itemsService.groupByBoolean(snapshot.votes, true),
            votesDown: this.itemsService.groupByBoolean(snapshot.votes, false)
        };
